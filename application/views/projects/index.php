            ...
            <tr>
                ...
                <td>
                    <div class="btn-group-vertical btn-group-sm" style="gap: 10px; flex-direction: row;">
                        ...
                        <a href="<?= site_url('projects/delete/'.$proj->id); ?>" class="btn btn-danger mb-1" onclick="return confirm('Delete this project?')" title="Delete"><i class="fas fa-trash"></i></a>
                    ...
                    <div class="btn-group btn-group-sm d-none " style="gap: 10px;">
                        ...
                        <a href="<?= site_url('projects/delete/'.$proj->id); ?>" class="btn btn-danger" onclick="return confirm('Delete this project?')">Delete</a>
